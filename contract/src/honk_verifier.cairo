...
full_proof.proof.lookup_read_tags.into()];
            ...
            into_u256_unchecked(scalar_68), transcript.shplonk_z.into()].span();
            ...
            let (lhs_fA0) = run_BN254_EVAL_FN_CHALLENGE_SING_41P_RLC_circuit(A:random_point, coeff:mb.coeff0, SumDlogDivBatched:full_proof.msm_hint_batched.RLCSumDlogDiv);
            let (lhs_fA2) = run_BN254_EVAL_FN_CHALLENGE_SING_41P_RLC_circuit(A:G1Point{x:mb.x_A2, y:mb.y_A2}, coeff:mb.coeff2, SumDlogDivBatched:full_proof.msm_hint_batched.RLCSumDlogDiv);
