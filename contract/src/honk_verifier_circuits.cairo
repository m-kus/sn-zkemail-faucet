...
#[inline(always)]
pub fn run_GRUMPKIN_HONK_SUMCHECK_SIZE_5_PUB_1_circuit(p_public_inputs:Span<u256>,p_public_inputs_offset:u384,sumcheck_univariates_flat:Span<u256>,sumcheck_evaluations:Span<u256>,tp_sum_check_u_challenges:Span<u128>,tp_gate_challenges:Span<u128>,tp_eta_1:u128,tp_eta_2:u128,tp_eta_3:u128,tp_beta:u128,tp_gamma:u128,tp_base_rlc:u384,tp_alphas:Span<u128>)->(u384,u384) {
 ...
 // CONSTANT stack
	 ...
	 let in25 = CE::<CI<25>> {}; // 0x10dc6e9c006ea38b04b1e03b4bd9490c0d03f98929ca1d7fb56821fd19d3b6e7
	 ...
	 let in28 = CE::<CI<28>> {}; // 0x222c01175718386f2e2e82eb122789e352e105a3b8fa852613bc534433ee428b
...
let t748 = circuit_sub(t747, t336); 
    ...
    // Prefill constants:
            ...
            circuit_inputs = circuit_inputs.next_span(HONK_SUMCHECK_SIZE_5_PUB_1_GRUMPKIN_CONSTANTS.span()); // in0 - in28
...
let t292 = circuit_add(t140, t172); 
    ...
    let mut circuit_inputs = (t16,t20,t24,t28,t32,t36,t40,t44,t48,t52,t56,t60,t64,t68,t72,t76,t80,t84,t88,t92,t96,t100,t104,t108,t112,t116,t120,t288,t289,t290,t291,t292,t144,t148,t152,t238,t253,t268,t283,t287,).new_inputs();
    // Prefill constants:
...
let scalar_68:u384 = outputs.get_output(t287);return (scalar_1,scalar_2,scalar_3,scalar_4,scalar_5,scalar_6,scalar_7,scalar_8,scalar_9,scalar_10,scalar_11,scalar_12,scalar_13,scalar_14,scalar_15,scalar_16,scalar_17,scalar_18,scalar_19,scalar_20,scalar_21,scalar_22,scalar_23,scalar_24,scalar_25,scalar_26,scalar_27,scalar_28,scalar_29,scalar_30,scalar_31,scalar_32,scalar_33,scalar_34,scalar_35,scalar_41,scalar_42,scalar_43,scalar_44,scalar_68);
}
pub fn run_BN254_EVAL_FN_CHALLENGE_SING_41P_RLC_circuit(A:G1Point,coeff:u384,SumDlogDivBatched:FunctionFelt)->(u384,) {
...
circuit_inputs = circuit_inputs.next_2(coeff); // in2
        ...
        let outputs = circuit_inputs.done_2().eval(modulus).unwrap();
let res:u384 = outputs.get_output(t362);return (res,);
}
    ...
    > of core::circuit::CircuitDefinition<
        (
            CE<E0>, CE<E1>, CE<E2>, CE<E3>, CE<E4>, CE<E5>, CE<E6>, CE<E7>, CE<E8>, CE<E9>, CE<E10>, CE<E11>, CE<E12>, CE<E13>, CE<E14>, CE<E15>, CE<E16>, CE<E17>, CE<E18>, CE<E19>, CE<E20>, CE<E21>, CE<E22>, CE<E23>, CE<E24>, CE<E25>, CE<E26>, CE<E27>, CE<E28>, CE<E29>, CE<E30>, CE<E31>, CE<E32>, CE<E33>, CE<E34>, CE<E35>, CE<E36>, CE<E37>, CE<E38>, CE<E39>
        )
    > {
        type CircuitType =
